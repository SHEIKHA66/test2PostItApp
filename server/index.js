...
//db connection
//const connectString = "mongodb+srv://user123:user123@postitcluster.rwtav.mongodb.net/postITDb?retryWrites=true&w=majority&appName=PostITCluster";
    ...
    if (userIndex !== -1) {
      ...
      const udpatedPost = await PostModel.findOneAndUpdate(
        { _id: postId },
        {
          ...
          $pull: { "likes.users": userId }, // Remove userId from the users
          array,
        },
